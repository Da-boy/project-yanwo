    ...
    <div class="clearfix">
      <div class="pagin fr" id="commentsPage0" style="margin-top:8px;">
        <form name="selectPageForm" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get">
          ...
          <?php $_from = $this->_var['pager']['page_number']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_36136300_1500221063');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_36136300_1500221063']):
?> 
          <?php if ($this->_var['pager']['page'] == $this->_var['key']): ?> 
          <a href="javascript:void(0)" class="current"><?php echo $this->_var['key']; ?></a> 
          <?php else: ?> 
          <a href="<?php echo $this->_var['item_0_36136300_1500221063']; ?>"><?php echo $this->_var['key']; ?></a> 
          <?php endif; ?> 
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
          ...
          <?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_36136300_1500221063');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_36136300_1500221063']):
?>
          <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_36136300_1500221063']; ?>" />
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </form>
      </div>
    </div>
...
//<![CDATA[
<?php $_from = $this->_var['lang']['cmt_lang']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_36136300_1500221063');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_36136300_1500221063']):
?>
var <?php echo $this->_var['key']; ?> = "<?php echo $this->_var['item_0_36136300_1500221063']; ?>";
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
