        ...
        <div id="newFittign-tab">
          ...
          <div class="master"> <s></s>
            ...
            <div class="p-name"> <a href="<?php echo $this->_var['goods']['url']; ?>" target="_blank"><?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?></a> </div>
             ...
             <label class="p-price"><strong>￥</strong><strong class="J-p-1045206"><?php echo $this->_var['goods']['shop_price']; ?></strong> </label></div>
          </div>
          <div class="suits" style="width:620px;overflow-x:auto;overflow-y:hidden;">
            <ul id="newFitting-0">
...
?> 
              ...
              <li> 
              <?php if (! ($this->_foreach['foo2']['iteration'] == $this->_foreach['foo2']['total'])): ?>
              <s></s>
              <?php endif; ?>
