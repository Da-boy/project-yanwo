...
?>
        ...
        <!--新加tr 卡类商品的-->
        <tr>
          <td class="label"> 套餐中每周瓶数：</td>
          <td><input type="text" name="week_num" value="<?php echo $this->_var['goods']['week_num']; ?>" size="20" />
            <br />
            <span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?> style="display:none" <?php endif; ?> id="rankIntegral">请填写每周会给客户送的瓶数（如：2、3等等纯数字，非卡类商品请勿填写）</span></td>
        </tr>
        <tr>
          <td class="label"> 套餐中总共瓶数：</td>
          <td><input type="text" name="total_num" value="<?php echo $this->_var['goods']['total_num']; ?>" size="20" />
            <br />
            <span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?> style="display:none" <?php endif; ?> id="rankIntegral">请填写此商品总共给客户送的瓶数（如：8、12等等纯数字，非卡类商品请勿填写）</span></td>
        </tr>

        <tr>
          <td class="label"> 商品小标签：</td>
          <td><input type="text" name="little_label" value="<?php echo $this->_var['goods']['little_label']; ?>" size="20" />
            <br />
            <span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?> style="display:none" <?php endif; ?> id="rankIntegral">请填写此商品简述</span></td>
        </tr>
        <!--新加tr 卡类商品的-->
