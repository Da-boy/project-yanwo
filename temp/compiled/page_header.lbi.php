...
?> </li>
                ...
                <dl class="categorys-brands">
                  ...
                  <dd>
                    <ul>
                      <?php $_from = $this->_var['cat']['brands']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'brands_0_19141200_1498198305');$this->_foreach['brands_no'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['brands_no']['total'] > 0):
    foreach ($_from AS $this->_var['brands_0_19141200_1498198305']):
        $this->_foreach['brands_no']['iteration']++;
?>
                       <?php if ($this->_foreach['brands_no']['iteration'] < 19): ?>
                      <li><a href="<?php echo $this->_var['brands_0_19141200_1498198305']['url']; ?>" target="_blank"><?php echo $this->_var['brands_0_19141200_1498198305']['brand_name']; ?></a></li>
                      <?php endif; ?>
 					 <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                    </ul>
                  </dd>
