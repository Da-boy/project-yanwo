...
<body>
<?php echo $this->fetch('library/page_header.lbi'); ?><?php echo $this->smarty_insert_scripts(array('files'=>'magiczoomplus.js,jd_goods.js')); ?> <?php echo $this->fetch('library/ur_here.lbi'); ?>
<div class="w">
  <div id="product-intro">
    <div id="name">
      <h1><?php echo $this->_var['goods']['goods_style_name']; ?></h1>
      <strong><?php echo $this->_var['goods']['goods_brief']; ?></strong> </div>
      ...
      <form action="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
        <ul id="summary">
          ...
          <li id="summary-price">
            ...
            <div class="dd"> <strong class="p-price" id="ECS_SHOPPRICE"><?php echo $this->_var['goods']['promote_price']; ?></strong> </div>
          ...
          <li id="summary-market">
            <div class="dt"><?php echo $this->_var['lang']['goods_sn']; ?>：</div>
            <div class="dd"><span><?php echo $this->_var['goods']['goods_sn']; ?></span></div>
          </li>
          <?php endif; ?> 
...
?>
              ...
              <div id="product-promotions"> 
                ...
                <em class="hl_red"><?php echo $this->_var['item']['act_name']; ?></em><a href="<?php echo $this->_var['item']['url']; ?>" target="_blank">&nbsp;&nbsp;详情 <s class="s-arrow">&gt;&gt;</s></a></div>
          ...
          <li id="summary-grade">
            ...
            <div class="dd"> <span class="star sa5"></span> <a href="#comment" style="float: left; ">(已有<?php echo $this->_var['goods']['comments_number']; ?>人评价)</a> <a id="j-im" style="display:none;" class="djd-im" href="#none" ><b>联系客服</b></a></div>
          </li>
          ...
          <li id="summary-tips" class="hide" style="display: list-item; ">
            ...
            <div class="dd">
              <div id="product-tips"><em class="hl_red"><?php echo $this->_var['goods']['integral']; ?> <?php echo $this->_var['points_name']; ?></em></div>
            </div>
          </li>
          <?php endif; ?> 
...
?>
              <div class="item<?php if ($this->_var['key'] == 0): ?> selected<?php endif; ?>"><b></b><a href="#none" title="<?php echo $this->_var['value']['label']; ?>" style="cursor: pointer; "><?php echo $this->_var['value']['label']; ?></a>
...
?> 
          ...
          <li id="choose-btns">
            ...
            <div id="choose-btn-coll" class="btn"> <a href="#none" onclick="javascript:collect(<?php echo $this->_var['goods']['goods_id']; ?>)" class="btn-coll" >加关注<b></b></a> </div>
...
?>
    ...
    <div id="ranklist" class="m m2">
      ...
      <div class="mc">
        ...
        <ul class="tabcon">
          <?php $_from = $this->_var['top10_price']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_46858000_1498224048');$this->_foreach['top10_price'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['top10_price']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_46858000_1498224048']):
...
?>
          <li class="fore<?php echo $this->_foreach['top10_price']['iteration']; ?>"><span><?php echo $this->_foreach['top10_price']['iteration']; ?></span>
            <div class="p-img"><a href="<?php echo $this->_var['goods_0_46858000_1498224048']['url']; ?>"><img height="50" width="50" src="<?php echo $this->_var['goods_0_46858000_1498224048']['thumb']; ?>"></a></div>
            <div class="p-name"><a href="<?php echo $this->_var['goods_0_46858000_1498224048']['url']; ?>" title="<?php echo $this->_var['goods_0_46858000_1498224048']['short_name']; ?>"><?php echo $this->_var['goods_0_46858000_1498224048']['short_name']; ?></a></div>
            <div class="p-price"><strong class="J-p-942510"><?php echo $this->_var['goods_0_46858000_1498224048']['price']; ?></strong></div>
          </li>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </ul>
        <ul class="tabcon hide">
          <?php $_from = $this->_var['top10_brand']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_46858000_1498224048');$this->_foreach['top10_brand'] = array('total' => count($_from), 'iteration' => 0);
...
?>
          <li class="fore<?php echo $this->_foreach['top10_brand']['iteration']; ?>"><span><?php echo $this->_foreach['top10_brand']['iteration']; ?></span>
            <div class="p-img"><a href="<?php echo $this->_var['goods_0_46858000_1498224048']['url']; ?>"><img data-img="1" height="50" width="50" src="<?php echo $this->_var['goods_0_46858000_1498224048']['thumb']; ?>" class="err-product"></a></div>
            <div class="p-name"><a href="<?php echo $this->_var['goods_0_46858000_1498224048']['url']; ?>" title="<?php echo $this->_var['goods_0_46858000_1498224048']['short_name']; ?>"><?php echo $this->_var['goods_0_46858000_1498224048']['short_name']; ?></a></div>
            <div class="p-price"><strong class="J-p-1029670"><?php echo $this->_var['goods_0_46858000_1498224048']['price']; ?></strong></div>
          </li>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </ul>
        <ul class="tabcon hide">
          <?php $_from = $this->_var['top10_category']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_46858000_1498224048');$this->_foreach['top10_category'] = array('total' => count($_from), 'iteration' => 0);
...
?>
          <li class="fore<?php echo $this->_foreach['top10_category']['iteration']; ?>"><span><?php echo $this->_foreach['top10_category']['iteration']; ?></span>
            <div class="p-img"><a href="<?php echo $this->_var['goods_0_46858000_1498224048']['url']; ?>"><img height="50" width="50" src="<?php echo $this->_var['goods_0_46858000_1498224048']['thumb']; ?>" class="err-product"></a></div>
            <div class="p-name"><a href="<?php echo $this->_var['goods_0_46858000_1498224048']['url']; ?>" title="<?php echo $this->_var['goods_0_46858000_1498224048']['short_name']; ?>"><?php echo $this->_var['goods_0_46858000_1498224048']['short_name']; ?></a></div>
            <div class="p-price"><strong class="J-p-1094930"><?php echo $this->_var['goods_0_46858000_1498224048']['price']; ?></strong></div>
          </li>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </ul>
      </div>
