...
?>
    <dl>
      ...
      <dd>
        <div class="p-name"><a href="<?php echo $this->_var['goods']['url']; ?>" target="_blank"><?php echo $this->_var['goods']['short_style_name']; ?><font color="#ff6600"></font></a><font color="#ff6600"><a target="blank" href="<?php echo $this->_var['goods']['url']; ?>"><?php echo $this->_var['goods']['short_style_name']; ?></a></font></div>
        <div class="p-price">本店价：<strong> <?php if ($this->_var['goods']['promote_price'] != ""): ?> 
