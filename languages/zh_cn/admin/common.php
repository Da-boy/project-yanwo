...
$_LANG['11_order_brief_list'] = '订单简表';
$_LANG['12_order_paid_list'] = '已付款订单';
$_LANG['13_order_goods_card'] = '套餐卡列表';
$_LANG['14_order_goods_card'] = '已完成套餐卡列表';
$_LANG['15_order_brief_list_fi'] = '已完成订单简表';
$_LANG['16_order_remind_music'] = '订单提醒音乐';
$_LANG['17_order_lucky'] = '中奖用户';
/* 广告管理 */
