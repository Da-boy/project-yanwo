...
$_LANG['order_view_brief'] = '订单简表';
$_LANG['order_paid_list'] = '已支付订单';
$_LANG['order_goods_card'] = '套餐卡列表';
$_LANG['order_goods_card_finish'] = '已完成套餐卡列表';
$_LANG['order_view_brief_finish'] = '已完成订单简表';
$_LANG['order_goods_card_edit'] = '套餐卡订单信息修改';
$_LANG['order_remind_music'] = '订单提醒音乐';
$_LANG['order_lucky']='中奖用户';
//促销管理
