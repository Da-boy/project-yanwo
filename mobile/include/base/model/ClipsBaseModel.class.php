...
class ClipsBaseModel extends BaseModel {
    ...
    public function add_message($message) {
        ...
        $data['telephone']=$message['msg_telephone'];
        $this->table = 'feedback';
        $this->insert($data);
    ...
    public function get_user_bonus($user_id = 0) {
        ...
        $sql = "SELECT SUM(bt.type_money) AS bonus_value, COUNT(*) AS bonus_count " .
                ...
                "WHERE ub.user_id = '$user_id' AND ub.bonus_type_id = bt.type_id AND ub.order_id = 0 AND ub.use_end_date>".local_gettime();
        $row = $this->row($sql);
    ...
    public function get_user_default($user_id) {
        ...
        //$info['integral'] = $row['pay_points'] . C('integral_name');//20160629修改
