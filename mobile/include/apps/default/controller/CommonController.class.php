...
class CommonController extends BaseController
{
    ...
    protected function getConName(){
        ...
        if($c=="Sell" && $a=="index"){
            $re=1;
        }elseif ($c=="User" && $a=="bonus") {
            $re=2;
        }  elseif ($c=="User" && $a=="bonusgq") {
            $re=2;
        }  elseif ($c=="Flow" && $a=="index") {
             $re=3;
        }  elseif ($c=="Flow" && $a=="cart") {
             $re=3;
        }   elseif ($c=="User" && $a=="index") {
             $re=4;
        }   elseif ($c=="User" && $a=="tongzhi") {
             $re=4;
        }   elseif ($c=="User" && $a=="jifen") {
             $re=4;
        }  elseif ($c=="User" && $a=="order_list") {
             $re=4;
        }  elseif ($c=="User" && $a=="money") {
            $re=4;
        }elseif ($c=="User" && $a=="card") {
            $re=4;
        }elseif ($c=="User" && $a=="card_gq") {
            $re=4;
        }elseif ($c=="Fuli" && $a=="water") {
            $re=4;
        }
        return $re;
    }
