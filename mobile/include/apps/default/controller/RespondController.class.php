    ...
    public function index()
    {
        ...
        if ($enabled == 0) {
            ...
            if (file_exists($plugin_file)) {
                ...
                $dispurl=(@$payobj->callback($this->data)) ?'zhifu_yes.dwt' :'zhifu_no.dwt';
        ...
        if(isset($_SESSION['order_type'])){
            ...
            $this->assign('fuserid', isset($_SESSION['user_id'])?$_SESSION['user_id']:0);
            
        }
        $this->assign('message', $msg);
        $this->assign('shop_url', __URL__);
        //$this->display('respond.dwt');
        $this->display($dispurl);
    }
