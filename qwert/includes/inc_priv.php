...
//  $purview['02_snatch_list']       = 'gift_manage';  //赠品管理
    ...
    $purview['16_gift_card_list']    = 'gift_card';  //礼品卡管理
...
//订单管理权限
    ...
    $purview['11_order_brief_list']  = 'order_view_brief';
    $purview['12_order_paid_list']  = 'order_paid_list';
    $purview['13_order_goods_card']  = 'order_goods_card';
    $purview['14_order_goods_card']  = 'order_goods_card_finish';
    $purview['15_order_brief_list_fi']  = 'order_view_brief_finish';
    $purview['16_order_remind_music']  = 'order_remind_music';
    $purview['17_order_lucky']            =   'lucky';//中奖用户
