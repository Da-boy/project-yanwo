...
$modules['03_promotion']['16_gift_card_list']       = 'gift_card.php?act=list';
...
$modules['04_order']['11_order_brief_list']         = 'order_view_brief.php?act=list';
$modules['04_order']['12_order_paid_list']         = 'order_paid_list.php?act=list';
$modules['04_order']['13_order_goods_card']         = 'order_goods_card.php?act=list';
$modules['04_order']['14_order_goods_card']         = 'order_goods_card_finish.php?act=list';
$modules['04_order']['15_order_brief_list_fi']         = 'order_view_brief_finish.php?act=list';
$modules['04_order']['16_order_remind_music']         = 'order_remind.php?act=edit';
$modules['04_order']['17_order_lucky']         = 'lucky.php?act=add';//中奖用户
