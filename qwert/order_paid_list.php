...
elseif ($_REQUEST['act'] == 'list')
{
    ...
    /* 显示模板 */
    assign_query_info();
    $smarty->display('order_paid_list.htm');
}
...
elseif ($_REQUEST['act'] == 'query')
{
    ...
    make_json_result($smarty->fetch('order_paid_list.htm'), '', array('filter' => $order_list['filter'], 'page_count' => $order_list['page_count']));
}
...
function order_list()
{
    ...
    if ($result === false)
    {
        ...
        $sql = "SELECT o.order_id, o.order_sn, o.add_time, o.order_status, o.shipping_status, o.order_amount, o.money_paid," .
            "o.pay_status, o.consignee, o.address, o.email, o.tel, o.mobile, o.is_kitchen,o.pay_name, o.extension_code, o.extension_id, " .
